...
const ProductsPage = ({ cart, setCart,addToCart }) => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50/30 to-cyan-50/20">
      {/* Header con gradiente sutil y formas */}
      <div className="relative bg-gradient-to-br from-blue-600/5 via-cyan-500/5 to-transparent pt-28 pb-16 px-4 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          {/* Stats con animaciones dinámicas */}
          <div className="flex flex-wrap justify-center gap-8 text-center">
            <div className="group bg-white/60 backdrop-blur-sm px-6 py-3 rounded-xl border border-slate-200/50 shadow-sm hover:shadow-lg hover:scale-110 hover:-rotate-2 transition-all duration-500 hover:bg-gradient-to-br hover:from-blue-50 hover:to-cyan-50 hover:border-blue-300 animate-fade-in-up">
            ...
            <div className="group bg-white/60 backdrop-blur-sm px-6 py-3 rounded-xl border border-slate-200/50 shadow-sm hover:shadow-lg hover:scale-110 transition-all duration-500 hover:bg-gradient-to-br hover:from-blue-50 hover:to-cyan-50 hover:border-blue-300 animate-fade-in-up" style={{animationDelay: '0.1s'}}>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="flex flex-col lg:flex-row gap-8">
          {/* Sidebar Filters con más contraste */}
          <div className={`lg:w-80 ${showFilters ? 'block' : 'hidden lg:block'}`}>
            <div className="sticky top-24 space-y-6">
              {/* Categories */}
              <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/80 shadow-sm">
              ...
              <div className="bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl p-6 shadow-lg text-white">
                ...
                <div className="space-y-2">
                  <button className="w-full text-left px-4 py-2.5 rounded-xl bg-white/20 hover:bg-white/30 backdrop-blur-sm transition flex items-center gap-2 border border-white/20">
          ...
          <div className="flex-1">
            {/* Toolbar */}
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-slate-200/80 shadow-sm mb-8">
            ...
            {filteredProducts.length === 0 ? (
              ...
              <div className={`grid gap-6 ${
                ...
                {filteredProducts.map(product => (
                  <div
                    key={product.id}
                    className={`group bg-white rounded-2xl border border-slate-200/80 hover:shadow-2xl hover:shadow-blue-500/10 hover:border-blue-200 transition-all duration-300 overflow-hidden ${
                      viewMode === 'list' ? 'flex' : ''
                    }`}
                  >
